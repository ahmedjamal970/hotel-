...
if(isset($_POST['booknow'])){
   ...
   if($day <= 0){
      ...
      addtocart($_POST['CARID'],$days, $totalprice,$_SESSION['arrival'],$_SESSION['departure'],0);
...
// ============================================================================================================================
                ...
                ?>
                 <form method="POST" action="index.php?p=accomodationcar">
                 <input type="hidden" name="RENT" value="<?php echo $result->RENT ;?>">
                  <input type="hidden" name="CARID" value="<?php echo $result->CARID ;?>">

                      <div class="card">
                        <img class="card-img-top"  src="<?php echo WEB_ROOT .'admin/mod_carrental/'.$result->CARIMAGE; ?>" alt="Car image description" height="250px" width="100px">
                        <div class="card-body">
                          <div class="rooms_title"><h2><?php echo $result->CAR ;?>  </h2></div>
                          <div class="rooms_text">
                            <p><?php echo $result->CARDESC ;?></p>
                          </div>
                         
                          <div class="rooms_price"><?php echo   $result->RENT ;?>/<span>Night</span></div>
                           <?php echo $btn ; ?> 
                        </div>
                      </div>
